(module
 ...
 (global $STACKTOP (mut i32) (i32.const 2800))
 (global $STACK_MAX (mut i32) (i32.const 5245680))
 ...
 (func $stackAlloc (; 7 ;) (param $size i32) (result i32)
  (local $ret i32)
  (local.set $ret
   (global.get $STACKTOP)
  )
 ...
 (func $stackRestore (; 9 ;) (param $top i32)
  (global.set $STACKTOP
   (local.get $top)
  )
 )
 (func $establishStackSpace (; 10 ;) (param $stackBase i32) (param $stackMax i32)
  (global.set $STACKTOP
   (local.get $stackBase)
  )
 ...
 (func $_malloc (; 11 ;) (param $$0 i32) (result i32)
  (local $$$0 i32)
  (local $$$0$i$i i32)
  (local $$$0$i$i$i i32)
  (local $$$0$i16$i i32)
 ...
 (func $_memcpy (; 13 ;) (param $dest i32) (param $src i32) (param $num i32) (result i32)
  (local $ret i32)
 ...
 (func $_memset (; 14 ;) (param $ptr i32) (param $value i32) (param $num i32) (result i32)
  (local $end i32)
 ...
 (func $_sbrk (; 15 ;) (param $increment i32) (result i32)
